...
export function renderComments() {
    ...
    commentsData.forEach((comment) => {
        ...
        if (user && user.token) {
            ...
            // Если пользователь не авторизован, кнопка дизейблится
            likeButtonHtml = `<button class="like-btn" disabled title="Войдите, чтобы поставить лайк">❤️</button>`
        }
    ...
    addLikeHandlers() // Навешиваем обработчики на лайки (если кнопки не disabled)
}
